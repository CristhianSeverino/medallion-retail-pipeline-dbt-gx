    ...
    create  table
      "sales"."main"."gold_fact_sales_aggregated__dbt_tmp"
...
JOIN "sales"."main"."silver_dim_customer" c ON f.customer_id = c.customer_id
JOIN "sales"."main"."silver_dim_product" p ON f.product_id = p.product_id
GROUP BY 1, 2, 3, 4
    );
